...
RUN set -x \
    ...
    && cd ~/jormungandr/ \
    && Dwnjor="https://github.com/input-output-hk/jormungandr/releases/download/v0.7.0-rc1/jormungandr-v0.7.0-rc1-x86_64-unknown-linux-gnu.tar.gz" \
    && Dwnjorf="jormungandr-v0.7.0-rc1-x86_64-unknown-linux-gnu.tar.gz" \
    && wget $Dwnjor \
    && tar xzvf $Dwnjorf \
    && rm $Dwnjorf \                
